...
void setup() {
  ...
  imu.setFusionAlgorithm(SensorFusion::FUSION);  // MADGWICK, MAHONY, COMPLEMENTARY, FUSION, CLASSIC, NONE
  //  Fusion settings
  ...
  imu.setFusionGain(0.4);        // Default Fusion Filter Gain 0.25 - try 7.5 for a much quicker response
